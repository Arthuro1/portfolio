  ...
  return (
    <section id="experience" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-12">{ex.title}</h2>
          ...
          <div className="space-y-10">
            {ex.items.map((exp, i) => (
              <div key={i} className="sm:pl-12 relative">
                <div className="hidden sm:flex absolute left-0 top-1.5 w-8 h-8 rounded-full bg-white border-2 border-blue-700 items-center justify-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mt-20 mb-10">{ex.educationTitle}</h2>
        <div className="space-y-6">
          {ex.education.map((edu, i) => (
            <div key={i} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 border-b border-gray-200 pb-6">
              <div>
