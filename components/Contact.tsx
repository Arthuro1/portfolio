    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-500 mb-12 max-w-xl">
          I&apos;m open to AI Engineering roles and interesting projects. Feel free to reach out.
        </p>
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-sm font-medium text-gray-800 group-hover:text-blue-700 transition-colors break-all">
          {value}
        </p>
      </div>
    </a>
